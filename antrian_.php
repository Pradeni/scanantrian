...
-->
        ...
        <div class="modal-body" style="padding-top:30px;">
          ...
          <div class="col-6 pt-3 pb-x3">
            <div id="printAntrianPendaftaran" style="display: none;" class="cetak">
              <div style="width: 200px; font-family: Tahoma; margin-top: 10px; margin-right: 5px; margin-bottom: 100px; margin-left: 15px; font-size: 21px !important;">
                <div id="print_nomor_pendaftaran"></div>
                Loket Pendaftaran
              </div>
            </div>
            <div id="display_nomor_pendaftaran"></div>
            <form role="form" id="formPendaftaran" name="formPendaftaran">
              <button type="submit" class="btn btn-lg btn-danger btn-block" style="padding: 30px;font-size:42px;" id="btnKRMPendaftaran" value="Submit" name="btnKRMPendaftaran" onclick="printDiv('printAntrianPendaftaran');">LOKET<br>PENDAFTARAN</button>
            </form>
          </div>
          <div class="col-6 pt-3 pb-3">
            ...
            <form role="form" id="formFarmasi" name="formFarmasi">
              <button type="submit" class="btn btn-lg btn-danger btn-block" style="padding: 30px;font-size:42px;" id="btnKRMFarmasi" value="Submit" name="btnKRMFarmasi" onclick="printDiv('printAntrianFarmasi');">LOKET<br>FARMASI</button>
            </form>
          </div>
          </div>
        </div>
              ...
              <div class="form-row">
                <div class="col form-group">
                  <label>Nomor Rekam Medik</label>
                    <input type="text" name="no_rkm_medis_daftar" class="form-control" placeholder="" id="no_rkm_medis_daftar">
                </div>
                <div class="col form-group">
                  <label>Nama Lengkap</label>
                    <input type="text" name="nm_pasien_daftar" class="form-control" placeholder=" " id="nm_pasien_daftar">
                </div>
              </div>
              <div class="form-group">
  ...
  $(document).ready(function() {
    setInterval(function(){
      $("#display_nomor_pendaftaran").load("{?=url()?}/anjungan/ajax?show=tampilPendaftaran");
      $("#print_nomor_pendaftaran").load("{?=url()?}/anjungan/ajax?show=printPendaftaran");
      $("#display_nomor_farmasi").load("{?=url()?}/anjungan/ajax?show=tampilFarmasi");
      $("#print_nomor_farmasi").load("{?=url()?}/anjungan/ajax?show=printFarmasi");
    }, 1000);
  })
  ...
  $(function () {
    ...
    $('#infoContinue').click(function (e) {
      ...
      setTimeout(function() { window.location.href = "{?=url('anjungan/pasien')?}"; }, 500000);
    ...
    $('#finish').click(function (e) {
      ...
      $.ajax({
          url:'{?=url()?}/anjungan/ajax?show=get-namadokter',
          type:'POST',
          dataType: "json",
          data:{
