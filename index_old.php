...
<html lang="en">
  ...
  <body>
    <div class="px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      ...
      <h2 class="display-5">silahkan menekan kotak hijau dibawah ini</h2>
    </div>
    <br><br>
    <div class="container">
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg  modal-fix" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h2 class="modal-title" id="exampleModalCenterTitle">Pilih jenis antrian yang anda butuhkan dibawah ini</h2>
          ...
          <div class="modal-body">
            ...
            <div class="col-6 pt-1 pb-1">
              ...
              <form role="form" id="formloket" name="formloket">
                <button type="submit" class="btn btn-lg btn-danger btn-block" id="btnKRM" value="Submit" name="btnKRM" onclick="printDiv('printAntrianPendaftaran');">ANTRIAN PENDAFTARAN</button>
              </form>
            </div>
<!--
            <div class="col-6 pt-1 pb-1">
