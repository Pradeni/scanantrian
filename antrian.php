...
<body>
  ...
  <div class="px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center mb-4">
    <div class="text-white display-3">ANTRIAN PENDAFTARAN RAWAT JALAN</div>
  </div>
        ...
        <a href="antrian.php?action=loket" style="text-decoration:none; color:#000;">
          <div class="card border-success mb-4">
            <div class="card-body text-success">
              <div style="font-size:130px;font-weight:lighter;padding:0;margin-top:-15px;margin-bottom:-15px;">A<span class="antrian_loket"><span></div>
            </div>
            <div class="card-footer bg-transparent border-success display-4">
    				  <div style="font-size:55px;font-weight:lighter;padding:0;margin-top:-15px;margin-bottom:-15px;">Loket Pendaftaran</div>
            </div>
          </div>
        </a>
      </div>
